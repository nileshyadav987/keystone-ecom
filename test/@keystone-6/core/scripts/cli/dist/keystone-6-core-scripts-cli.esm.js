...
import { s as staticAdminMetaQuery } from '../../../dist/admin-meta-graphql-81d6aaf0.esm.js';
import { c as createSystem } from '../../../dist/createSystem-86342e70.esm.js';
import { d as devMigrations, p as pushPrismaSchemaToDatabase } from '../../../dist/migrations-6186d51a.esm.js';
import { g as getEsbuildConfig, l as loadBuiltConfig, a as loadConfigOnce } from '../../../dist/loadConfig-a7ff371f.esm.js';
import { d as defaults, b as createAdminUIMiddlewareWithNextApp, c as createExpressServer, g as getNextApp, a as createAdminUIMiddleware } from '../../../dist/createAdminUIMiddleware-a59d0c34.esm.js';
import os from 'os';
import ci from 'ci-info';
import Conf from 'conf';
import fetch from 'node-fetch';
import { p as printPrismaSchema, g as getSchemaPaths, a as getFormattedGraphQLSchema, b as generateNodeModulesArtifactsWithoutPrismaClient, c as generateCommittedArtifacts, d as generateNodeModulesArtifacts, r as requirePrismaClient, v as validateCommittedArtifacts } from '../../../dist/artifacts-3865cfe9.esm.js';
import { E as ExitError, g as getAdminPath, a as getBuiltConfigPath } from '../../../dist/utils-a8fea457.esm.js';
import { u as initialiseLists } from '../../../dist/types-for-lists-6eb29eda.esm.js';
...
No telemetry data has been sent yet, but will be sent the next time you run ${chalk.green('keystone dev')} unless you first opt-out.
...
const dev = async (cwd, shouldDropDatabase) => {
  ...
  const initialBuildResult = await esbuild.build(_objectSpread(_objectSpread({}, getEsbuildConfig(cwd)), {}, {
    watch: {
  ...
  const initKeystone = async () => {
    ...
    const originalPrismaSchema = printPrismaSchema(initialisedLists, config.db.provider, config.db.prismaPreviewFeatures, config.db.additionalPrismaDatasourceProperties);
...
const start = async cwd => {
  ...
  if (!((_config$ui = config.ui) !== null && _config$ui !== void 0 && _config$ui.isDisabled)) {
    ...
    expressServer.use(await createAdminUIMiddleware(config, keystone.context, false, getAdminPath(cwd)));
    console.log(`✅ Admin UI ready`);
  }
  const httpOptions = {
    port: 3000
