...
import { uriToCredentials, createDatabase } from '@prisma/internals';
import { Migrate } from '@prisma/migrate';
import chalk from 'chalk';
import slugify from '@sindresorhus/slugify';
import { E as ExitError } from './utils-a8fea457.esm.js';
import { c as confirmPrompt, t as textPrompt } from './prompts-97fdb385.esm.js';
...
async function pushPrismaSchemaToDatabase(dbUrl, shadowDbUrl, schema, schemaPath) {
  ...
  let before = Date.now();
  await ensureDatabaseExists(dbUrl, path__default.dirname(schemaPath));
...
export { devMigrations as d, pushPrismaSchemaToDatabase as p, runMigrateWithDbUrl as r, withMigrate as w };
