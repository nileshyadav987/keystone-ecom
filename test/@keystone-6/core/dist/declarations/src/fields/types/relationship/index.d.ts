...
declare type CountDisplayConfig = {
    many: true;
    ui?: {
        displayMode: 'count';
    };
};
declare type OneDbConfig = {
    many?: false;
    db?: {
        foreignKey?: true | {
            map: string;
...
declare type ManyDbConfig = {
    many: true;
    db?: {
        relationName?: string;
    };
};
export declare type RelationshipFieldConfig<ListTypeInfo extends BaseListTypeInfo> = CommonFieldConfig<ListTypeInfo> & {
    many?: boolean;
    ref: string;
    ui?: {
        hideCreate?: boolean;
