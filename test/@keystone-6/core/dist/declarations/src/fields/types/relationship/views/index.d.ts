...
declare type SingleRelationshipValue = {
    kind: 'one';
    id: null | string;
    initialValue: {
        label: string;
...
declare type ManyRelationshipValue = {
    kind: 'many';
    id: null | string;
    initialValue: {
        label: string;
...
declare type CardsRelationshipValue = {
    kind: 'cards-view';
    id: null | string;
...
declare type CountRelationshipValue = {
    kind: 'count';
    id: null | string;
    count: number;
};
declare type CardsDisplayModeOptions = {
...
declare type RelationshipController = FieldController<ManyRelationshipValue | SingleRelationshipValue | CardsRelationshipValue | CountRelationshipValue, string> & {
